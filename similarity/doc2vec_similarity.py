...
doc2vec_model = Doc2Vec.load('exports/Doc2Vec_0.model')
print('Model loaded!')
...
lda_model = gensim.models.LdaModel.load('exports/lda.model')
...
row_num = 2
workbook = xlsxwriter.Workbook('exports/similarity_report_all_1.xlsx',{'nan_inf_to_errors': True})
